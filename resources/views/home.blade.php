...
@extends('layouts.main')
    ...
    <section class="slider-home-1 owl-carousel owl-theme">
        <div class="slides item" style="background-image: url({{asset('images/vallon-d-en-vau-03.png') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="home-life">
        ...
        <div class="slides item" style="background-image: url({{asset('images/2000.png') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="home-life">
        ...
        <div class="slides item" style="background-image: url({{asset('images/3000.png') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="home-life">
        ...
        <div class="slides item"  style="background-image: url({{asset('images/4000.png') }})">
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="home-life">
      ...
      <section class="what-we-provide gap no-top">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div style="background-color:hsl(122, 94%, 50%)" class="volunteer donation">
                <i>
                  <svg
                     version="1.1"
                     id="svg1605"
        ...
        <div class="container">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              ...
              <div class="col-4">
                <div class="help-man hoverimg">
                  <img alt="man" class="helptwo" src="{{asset('images/140x140.jpg')}}">
                  <figure>
                    <img alt="man" class="w-100 mt-4" src="{{asset('images/196x196.jpg')}}">
                  </figure>
                </div>
              </div>
              </div>
            ...
            <div class="col-lg-6 ps-xl-5">
              <div class="help-man-data">
                <p>
                    ...
                    lam augue lorem ipsum dolor sit amet Lorem ips 
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6">
              <div class="upcoming-event-img">
                <figure>
                  <img alt="upcoming-events" src="https://via.placeholder.com/360x290">
                </figure>
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="upcoming-event-img mb-0">
                <figure>
                  <img alt="upcoming-events" src="https://via.placeholder.com/360x290">
                </figure>
                <a href="event-details.html"><i class="fa-solid fa-angle-right"></i></a>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-xl-7 col-lg-12">
              <div class="row change-we-img hoverimg">
                <div class="col-8">
                  <figure>
                    <img alt="We Need" class="w-100" src="https://via.placeholder.com/489x330">
                  </figure>
                </div>
                <div class="col-4">
                  <figure>
                    <img alt="We Need" class="w-100" src="https://via.placeholder.com/260x290">
                  </figure>
                </div>
                <div class="col-4">
                  <figure>
                    <img class="mt-4 w-100" alt="We Need" src="https://via.placeholder.com/260x290">
                  </figure>
                </div>
                <div class="col-8">
                  <figure>
                    <img class="mt-4 w-100" alt="We Need" src="https://via.placeholder.com/489x330">
                  </figure>
                </div>
              </div>
            </div>
      ...
      <section class="environment-section" style="background-image: url(https://via.placeholder.com/1920x766);">
        <div class="container">
          ...
          <div class="slider-wrapper">
            ...
            <div class="slider-nav">
              <div class="slider-nav__item">
                <img alt="img" src="https://via.placeholder.com/152x152">
              </div>
              <div class="slider-nav__item">
                <img alt="img" src="https://via.placeholder.com/152x152">
              </div>
        ...
        <div class="container">
          ...
          <div class="row gifts-slids owl-carousel owl-theme">
            <div class="col-lg-12 item">
              <div class="gifts-img">
                <img alt="gifts-img" src="https://via.placeholder.com/220x220">
                <div class="add-to-cart">
                  <div class="start d-flex align-items-center ps-4">
