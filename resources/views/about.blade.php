...
@extends('layouts.main')
    ...
    <section class="page-title-area" style="background-image:url(https://via.placeholder.com/1920x430)">
          ...
          <div class="row">
            <div class="col-lg-5">
              <div class="about-text">
                <p>
                  Duis sed odio sit amet nibh vulputate cursus a amet ma accumsan ipsuy veli Nam nec tellus per coec tellus. curs a amet mauli accumsan ipsuy veli Nam nec tell cumsan
            ...
            <div class="col-md-6 ">
              <div class="about-img hoverimg">
                <figure>
                  <img alt="img" src="https://via.placeholder.com/636x363">
                </figure>
              </div>
            </div>
            <div class="col-md-6">
      ...
      <section class="gap charity-services">
        <div class="container">
      ...
      <section class="fundraising gap no-bottom" style="background-image:url('https://via.placeholder.com/1920x628')">
        <div class="container">
          <div class="heading">
            <img alt="icon" src="assets/img/logo-icon.png">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 p-0">
              <div class="fundraising-data">
                <div class="Fund-cercle">
                  <span>1</span>
                  <i>
            ...
            <div class="col-lg-4 col-md-6 p-0">
              <div class="fundraising-data two">
                <div class="Fund-cercle">
                  <span>2</span>
                  <i>
                    <svg
            ...
            <div class="col-lg-4 col-md-6 p-0">
              <div class="fundraising-data three">
                <div class="Fund-cercle">
                  <span>3</span>
                    <i>
                      <svg
      ...
      <section class="gap about-img-slidr">
        <div class="container">
          <div class="heading">
            <img alt="icon" src="assets/img/logo-icon.png">
          ...
          <div class="slider-wrapper">
            ...
            <div class="slider-for-two">
              ...
              <h4>Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  deserunt mollit anim id est dolor sit amet, consectetur adipisi
                  sed do eiusmod tempor incididunt ut labore..</h4>
                  <div class="start d-flex align-items-center pt-4">
